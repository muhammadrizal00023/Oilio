...
contract Oilio {
    ...
    function refineryEnvelope_276(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 656) + (bIn * 3) + cIn + 276;
        uint256 y = (bIn * 399) + (cIn * 5) + aIn + 287;
        uint256 z = (cIn * 1080) + (aIn * 7) + bIn + 295;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_277(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 673) + (bIn * 3) + cIn + 277;
        uint256 y = (bIn * 422) + (cIn * 5) + aIn + 288;
        uint256 z = (cIn * 1111) + (aIn * 7) + bIn + 296;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_278(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 690) + (bIn * 3) + cIn + 278;
        uint256 y = (bIn * 445) + (cIn * 5) + aIn + 289;
        uint256 z = (cIn * 1142) + (aIn * 7) + bIn + 297;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_279(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 707) + (bIn * 3) + cIn + 279;
        uint256 y = (bIn * 468) + (cIn * 5) + aIn + 290;
        uint256 z = (cIn * 1173) + (aIn * 7) + bIn + 298;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_280(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 724) + (bIn * 3) + cIn + 280;
        uint256 y = (bIn * 491) + (cIn * 5) + aIn + 291;
        uint256 z = (cIn * 1204) + (aIn * 7) + bIn + 299;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_281(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 741) + (bIn * 3) + cIn + 281;
        uint256 y = (bIn * 514) + (cIn * 5) + aIn + 292;
        uint256 z = (cIn * 1235) + (aIn * 7) + bIn + 300;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_282(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 758) + (bIn * 3) + cIn + 282;
        uint256 y = (bIn * 537) + (cIn * 5) + aIn + 293;
        uint256 z = (cIn * 1266) + (aIn * 7) + bIn + 301;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_283(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 775) + (bIn * 3) + cIn + 283;
        uint256 y = (bIn * 560) + (cIn * 5) + aIn + 294;
        uint256 z = (cIn * 1297) + (aIn * 7) + bIn + 302;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_284(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 792) + (bIn * 3) + cIn + 284;
        uint256 y = (bIn * 583) + (cIn * 5) + aIn + 295;
        uint256 z = (cIn * 351) + (aIn * 7) + bIn + 303;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_285(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 809) + (bIn * 3) + cIn + 285;
        uint256 y = (bIn * 606) + (cIn * 5) + aIn + 296;
        uint256 z = (cIn * 382) + (aIn * 7) + bIn + 304;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_286(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 826) + (bIn * 3) + cIn + 286;
        uint256 y = (bIn * 629) + (cIn * 5) + aIn + 297;
        uint256 z = (cIn * 413) + (aIn * 7) + bIn + 305;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_287(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 843) + (bIn * 3) + cIn + 287;
        uint256 y = (bIn * 652) + (cIn * 5) + aIn + 298;
        uint256 z = (cIn * 444) + (aIn * 7) + bIn + 306;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_288(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 860) + (bIn * 3) + cIn + 288;
        uint256 y = (bIn * 675) + (cIn * 5) + aIn + 299;
        uint256 z = (cIn * 475) + (aIn * 7) + bIn + 307;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_289(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 176) + (bIn * 3) + cIn + 289;
        uint256 y = (bIn * 698) + (cIn * 5) + aIn + 300;
        uint256 z = (cIn * 506) + (aIn * 7) + bIn + 308;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_290(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 193) + (bIn * 3) + cIn + 290;
        uint256 y = (bIn * 721) + (cIn * 5) + aIn + 301;
        uint256 z = (cIn * 537) + (aIn * 7) + bIn + 309;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_291(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 210) + (bIn * 3) + cIn + 291;
        uint256 y = (bIn * 744) + (cIn * 5) + aIn + 302;
        uint256 z = (cIn * 568) + (aIn * 7) + bIn + 310;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_292(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 227) + (bIn * 3) + cIn + 292;
        uint256 y = (bIn * 767) + (cIn * 5) + aIn + 303;
        uint256 z = (cIn * 599) + (aIn * 7) + bIn + 311;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_293(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 244) + (bIn * 3) + cIn + 293;
        uint256 y = (bIn * 790) + (cIn * 5) + aIn + 304;
        uint256 z = (cIn * 630) + (aIn * 7) + bIn + 312;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_294(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 261) + (bIn * 3) + cIn + 294;
        uint256 y = (bIn * 813) + (cIn * 5) + aIn + 305;
        uint256 z = (cIn * 661) + (aIn * 7) + bIn + 313;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_295(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 278) + (bIn * 3) + cIn + 295;
        uint256 y = (bIn * 836) + (cIn * 5) + aIn + 306;
        uint256 z = (cIn * 692) + (aIn * 7) + bIn + 314;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_296(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 295) + (bIn * 3) + cIn + 296;
        uint256 y = (bIn * 859) + (cIn * 5) + aIn + 307;
        uint256 z = (cIn * 723) + (aIn * 7) + bIn + 315;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_297(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 312) + (bIn * 3) + cIn + 297;
        uint256 y = (bIn * 882) + (cIn * 5) + aIn + 308;
        uint256 z = (cIn * 754) + (aIn * 7) + bIn + 316;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_298(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 329) + (bIn * 3) + cIn + 298;
        uint256 y = (bIn * 905) + (cIn * 5) + aIn + 309;
        uint256 z = (cIn * 785) + (aIn * 7) + bIn + 317;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_299(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 346) + (bIn * 3) + cIn + 299;
        uint256 y = (bIn * 928) + (cIn * 5) + aIn + 310;
        uint256 z = (cIn * 816) + (aIn * 7) + bIn + 318;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_300(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 363) + (bIn * 3) + cIn + 300;
        uint256 y = (bIn * 951) + (cIn * 5) + aIn + 311;
        uint256 z = (cIn * 847) + (aIn * 7) + bIn + 319;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_301(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 380) + (bIn * 3) + cIn + 301;
        uint256 y = (bIn * 974) + (cIn * 5) + aIn + 312;
        uint256 z = (cIn * 878) + (aIn * 7) + bIn + 320;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_302(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 397) + (bIn * 3) + cIn + 302;
        uint256 y = (bIn * 997) + (cIn * 5) + aIn + 313;
        uint256 z = (cIn * 909) + (aIn * 7) + bIn + 321;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_303(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 414) + (bIn * 3) + cIn + 303;
        uint256 y = (bIn * 1020) + (cIn * 5) + aIn + 314;
        uint256 z = (cIn * 940) + (aIn * 7) + bIn + 322;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_304(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 431) + (bIn * 3) + cIn + 304;
        uint256 y = (bIn * 1043) + (cIn * 5) + aIn + 315;
        uint256 z = (cIn * 971) + (aIn * 7) + bIn + 323;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_305(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 448) + (bIn * 3) + cIn + 305;
        uint256 y = (bIn * 1066) + (cIn * 5) + aIn + 316;
        uint256 z = (cIn * 1002) + (aIn * 7) + bIn + 324;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_306(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 465) + (bIn * 3) + cIn + 306;
        uint256 y = (bIn * 1089) + (cIn * 5) + aIn + 317;
        uint256 z = (cIn * 1033) + (aIn * 7) + bIn + 325;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_307(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 482) + (bIn * 3) + cIn + 307;
        uint256 y = (bIn * 1112) + (cIn * 5) + aIn + 318;
        uint256 z = (cIn * 1064) + (aIn * 7) + bIn + 326;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_308(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 499) + (bIn * 3) + cIn + 308;
        uint256 y = (bIn * 1135) + (cIn * 5) + aIn + 319;
        uint256 z = (cIn * 1095) + (aIn * 7) + bIn + 327;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_309(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 516) + (bIn * 3) + cIn + 309;
        uint256 y = (bIn * 271) + (cIn * 5) + aIn + 320;
        uint256 z = (cIn * 1126) + (aIn * 7) + bIn + 328;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_310(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 533) + (bIn * 3) + cIn + 310;
        uint256 y = (bIn * 294) + (cIn * 5) + aIn + 321;
        uint256 z = (cIn * 1157) + (aIn * 7) + bIn + 329;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_311(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 550) + (bIn * 3) + cIn + 311;
        uint256 y = (bIn * 317) + (cIn * 5) + aIn + 322;
        uint256 z = (cIn * 1188) + (aIn * 7) + bIn + 330;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_312(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 567) + (bIn * 3) + cIn + 312;
        uint256 y = (bIn * 340) + (cIn * 5) + aIn + 323;
        uint256 z = (cIn * 1219) + (aIn * 7) + bIn + 331;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_313(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 584) + (bIn * 3) + cIn + 313;
        uint256 y = (bIn * 363) + (cIn * 5) + aIn + 324;
        uint256 z = (cIn * 1250) + (aIn * 7) + bIn + 332;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_314(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 601) + (bIn * 3) + cIn + 314;
        uint256 y = (bIn * 386) + (cIn * 5) + aIn + 325;
        uint256 z = (cIn * 1281) + (aIn * 7) + bIn + 333;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_315(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 618) + (bIn * 3) + cIn + 315;
        uint256 y = (bIn * 409) + (cIn * 5) + aIn + 326;
        uint256 z = (cIn * 1312) + (aIn * 7) + bIn + 334;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_316(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 635) + (bIn * 3) + cIn + 316;
        uint256 y = (bIn * 432) + (cIn * 5) + aIn + 327;
        uint256 z = (cIn * 366) + (aIn * 7) + bIn + 335;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_317(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 652) + (bIn * 3) + cIn + 317;
        uint256 y = (bIn * 455) + (cIn * 5) + aIn + 328;
        uint256 z = (cIn * 397) + (aIn * 7) + bIn + 336;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_318(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 669) + (bIn * 3) + cIn + 318;
        uint256 y = (bIn * 478) + (cIn * 5) + aIn + 329;
        uint256 z = (cIn * 428) + (aIn * 7) + bIn + 337;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_319(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 686) + (bIn * 3) + cIn + 319;
        uint256 y = (bIn * 501) + (cIn * 5) + aIn + 330;
        uint256 z = (cIn * 459) + (aIn * 7) + bIn + 338;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_320(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 703) + (bIn * 3) + cIn + 320;
        uint256 y = (bIn * 524) + (cIn * 5) + aIn + 331;
        uint256 z = (cIn * 490) + (aIn * 7) + bIn + 339;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_321(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 720) + (bIn * 3) + cIn + 321;
        uint256 y = (bIn * 547) + (cIn * 5) + aIn + 332;
        uint256 z = (cIn * 521) + (aIn * 7) + bIn + 340;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_322(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 737) + (bIn * 3) + cIn + 322;
        uint256 y = (bIn * 570) + (cIn * 5) + aIn + 333;
        uint256 z = (cIn * 552) + (aIn * 7) + bIn + 341;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_323(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 754) + (bIn * 3) + cIn + 323;
        uint256 y = (bIn * 593) + (cIn * 5) + aIn + 334;
        uint256 z = (cIn * 583) + (aIn * 7) + bIn + 342;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_324(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 771) + (bIn * 3) + cIn + 324;
        uint256 y = (bIn * 616) + (cIn * 5) + aIn + 335;
        uint256 z = (cIn * 614) + (aIn * 7) + bIn + 343;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_325(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 788) + (bIn * 3) + cIn + 325;
        uint256 y = (bIn * 639) + (cIn * 5) + aIn + 336;
        uint256 z = (cIn * 645) + (aIn * 7) + bIn + 344;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_326(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 805) + (bIn * 3) + cIn + 326;
        uint256 y = (bIn * 662) + (cIn * 5) + aIn + 337;
        uint256 z = (cIn * 676) + (aIn * 7) + bIn + 345;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_327(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 822) + (bIn * 3) + cIn + 327;
        uint256 y = (bIn * 685) + (cIn * 5) + aIn + 338;
        uint256 z = (cIn * 707) + (aIn * 7) + bIn + 346;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_328(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 839) + (bIn * 3) + cIn + 328;
        uint256 y = (bIn * 708) + (cIn * 5) + aIn + 339;
        uint256 z = (cIn * 738) + (aIn * 7) + bIn + 347;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_329(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 856) + (bIn * 3) + cIn + 329;
        uint256 y = (bIn * 731) + (cIn * 5) + aIn + 340;
        uint256 z = (cIn * 769) + (aIn * 7) + bIn + 348;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_330(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 172) + (bIn * 3) + cIn + 330;
        uint256 y = (bIn * 754) + (cIn * 5) + aIn + 341;
        uint256 z = (cIn * 800) + (aIn * 7) + bIn + 349;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_331(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 189) + (bIn * 3) + cIn + 331;
        uint256 y = (bIn * 777) + (cIn * 5) + aIn + 342;
        uint256 z = (cIn * 831) + (aIn * 7) + bIn + 350;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_332(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 206) + (bIn * 3) + cIn + 332;
        uint256 y = (bIn * 800) + (cIn * 5) + aIn + 343;
        uint256 z = (cIn * 862) + (aIn * 7) + bIn + 351;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_333(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 223) + (bIn * 3) + cIn + 333;
        uint256 y = (bIn * 823) + (cIn * 5) + aIn + 344;
        uint256 z = (cIn * 893) + (aIn * 7) + bIn + 352;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_334(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 240) + (bIn * 3) + cIn + 334;
        uint256 y = (bIn * 846) + (cIn * 5) + aIn + 345;
        uint256 z = (cIn * 924) + (aIn * 7) + bIn + 353;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_335(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 257) + (bIn * 3) + cIn + 335;
        uint256 y = (bIn * 869) + (cIn * 5) + aIn + 346;
        uint256 z = (cIn * 955) + (aIn * 7) + bIn + 354;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_336(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 274) + (bIn * 3) + cIn + 336;
        uint256 y = (bIn * 892) + (cIn * 5) + aIn + 347;
        uint256 z = (cIn * 986) + (aIn * 7) + bIn + 355;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_337(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 291) + (bIn * 3) + cIn + 337;
        uint256 y = (bIn * 915) + (cIn * 5) + aIn + 348;
        uint256 z = (cIn * 1017) + (aIn * 7) + bIn + 356;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_338(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 308) + (bIn * 3) + cIn + 338;
        uint256 y = (bIn * 938) + (cIn * 5) + aIn + 349;
        uint256 z = (cIn * 1048) + (aIn * 7) + bIn + 357;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_339(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 325) + (bIn * 3) + cIn + 339;
        uint256 y = (bIn * 961) + (cIn * 5) + aIn + 350;
        uint256 z = (cIn * 1079) + (aIn * 7) + bIn + 358;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_340(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 342) + (bIn * 3) + cIn + 340;
        uint256 y = (bIn * 984) + (cIn * 5) + aIn + 351;
        uint256 z = (cIn * 1110) + (aIn * 7) + bIn + 359;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_341(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 359) + (bIn * 3) + cIn + 341;
        uint256 y = (bIn * 1007) + (cIn * 5) + aIn + 352;
        uint256 z = (cIn * 1141) + (aIn * 7) + bIn + 360;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_342(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 376) + (bIn * 3) + cIn + 342;
        uint256 y = (bIn * 1030) + (cIn * 5) + aIn + 353;
        uint256 z = (cIn * 1172) + (aIn * 7) + bIn + 361;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_343(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 393) + (bIn * 3) + cIn + 343;
        uint256 y = (bIn * 1053) + (cIn * 5) + aIn + 354;
        uint256 z = (cIn * 1203) + (aIn * 7) + bIn + 362;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_344(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 410) + (bIn * 3) + cIn + 344;
        uint256 y = (bIn * 1076) + (cIn * 5) + aIn + 355;
        uint256 z = (cIn * 1234) + (aIn * 7) + bIn + 363;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_345(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 427) + (bIn * 3) + cIn + 345;
        uint256 y = (bIn * 1099) + (cIn * 5) + aIn + 356;
        uint256 z = (cIn * 1265) + (aIn * 7) + bIn + 364;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_346(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 444) + (bIn * 3) + cIn + 346;
        uint256 y = (bIn * 1122) + (cIn * 5) + aIn + 357;
        uint256 z = (cIn * 1296) + (aIn * 7) + bIn + 365;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_347(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 461) + (bIn * 3) + cIn + 347;
        uint256 y = (bIn * 1145) + (cIn * 5) + aIn + 358;
        uint256 z = (cIn * 350) + (aIn * 7) + bIn + 366;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_348(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 478) + (bIn * 3) + cIn + 348;
        uint256 y = (bIn * 281) + (cIn * 5) + aIn + 359;
        uint256 z = (cIn * 381) + (aIn * 7) + bIn + 367;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_349(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 495) + (bIn * 3) + cIn + 349;
        uint256 y = (bIn * 304) + (cIn * 5) + aIn + 360;
        uint256 z = (cIn * 412) + (aIn * 7) + bIn + 368;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_350(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 512) + (bIn * 3) + cIn + 350;
        uint256 y = (bIn * 327) + (cIn * 5) + aIn + 361;
        uint256 z = (cIn * 443) + (aIn * 7) + bIn + 369;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_351(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 529) + (bIn * 3) + cIn + 351;
        uint256 y = (bIn * 350) + (cIn * 5) + aIn + 362;
        uint256 z = (cIn * 474) + (aIn * 7) + bIn + 370;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_352(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 546) + (bIn * 3) + cIn + 352;
        uint256 y = (bIn * 373) + (cIn * 5) + aIn + 363;
        uint256 z = (cIn * 505) + (aIn * 7) + bIn + 371;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_353(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 563) + (bIn * 3) + cIn + 353;
        uint256 y = (bIn * 396) + (cIn * 5) + aIn + 364;
        uint256 z = (cIn * 536) + (aIn * 7) + bIn + 372;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_354(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 580) + (bIn * 3) + cIn + 354;
        uint256 y = (bIn * 419) + (cIn * 5) + aIn + 365;
        uint256 z = (cIn * 567) + (aIn * 7) + bIn + 373;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_355(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 597) + (bIn * 3) + cIn + 355;
        uint256 y = (bIn * 442) + (cIn * 5) + aIn + 366;
        uint256 z = (cIn * 598) + (aIn * 7) + bIn + 374;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_356(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 614) + (bIn * 3) + cIn + 356;
        uint256 y = (bIn * 465) + (cIn * 5) + aIn + 367;
        uint256 z = (cIn * 629) + (aIn * 7) + bIn + 375;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_357(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 631) + (bIn * 3) + cIn + 357;
        uint256 y = (bIn * 488) + (cIn * 5) + aIn + 368;
        uint256 z = (cIn * 660) + (aIn * 7) + bIn + 376;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_358(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 648) + (bIn * 3) + cIn + 358;
        uint256 y = (bIn * 511) + (cIn * 5) + aIn + 369;
        uint256 z = (cIn * 691) + (aIn * 7) + bIn + 377;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_359(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 665) + (bIn * 3) + cIn + 359;
        uint256 y = (bIn * 534) + (cIn * 5) + aIn + 370;
        uint256 z = (cIn * 722) + (aIn * 7) + bIn + 378;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_360(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 682) + (bIn * 3) + cIn + 360;
        uint256 y = (bIn * 557) + (cIn * 5) + aIn + 371;
        uint256 z = (cIn * 753) + (aIn * 7) + bIn + 379;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_361(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 699) + (bIn * 3) + cIn + 361;
        uint256 y = (bIn * 580) + (cIn * 5) + aIn + 372;
        uint256 z = (cIn * 784) + (aIn * 7) + bIn + 380;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_362(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 716) + (bIn * 3) + cIn + 362;
        uint256 y = (bIn * 603) + (cIn * 5) + aIn + 373;
        uint256 z = (cIn * 815) + (aIn * 7) + bIn + 381;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_363(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 733) + (bIn * 3) + cIn + 363;
        uint256 y = (bIn * 626) + (cIn * 5) + aIn + 374;
        uint256 z = (cIn * 846) + (aIn * 7) + bIn + 382;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_364(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 750) + (bIn * 3) + cIn + 364;
        uint256 y = (bIn * 649) + (cIn * 5) + aIn + 375;
        uint256 z = (cIn * 877) + (aIn * 7) + bIn + 383;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_365(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 767) + (bIn * 3) + cIn + 365;
        uint256 y = (bIn * 672) + (cIn * 5) + aIn + 376;
        uint256 z = (cIn * 908) + (aIn * 7) + bIn + 384;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_366(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 784) + (bIn * 3) + cIn + 366;
        uint256 y = (bIn * 695) + (cIn * 5) + aIn + 377;
        uint256 z = (cIn * 939) + (aIn * 7) + bIn + 385;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_367(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 801) + (bIn * 3) + cIn + 367;
        uint256 y = (bIn * 718) + (cIn * 5) + aIn + 378;
        uint256 z = (cIn * 970) + (aIn * 7) + bIn + 386;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_368(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 818) + (bIn * 3) + cIn + 368;
        uint256 y = (bIn * 741) + (cIn * 5) + aIn + 379;
        uint256 z = (cIn * 1001) + (aIn * 7) + bIn + 387;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_369(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 835) + (bIn * 3) + cIn + 369;
        uint256 y = (bIn * 764) + (cIn * 5) + aIn + 380;
        uint256 z = (cIn * 1032) + (aIn * 7) + bIn + 388;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_370(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 852) + (bIn * 3) + cIn + 370;
        uint256 y = (bIn * 787) + (cIn * 5) + aIn + 381;
        uint256 z = (cIn * 1063) + (aIn * 7) + bIn + 389;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_371(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 869) + (bIn * 3) + cIn + 371;
        uint256 y = (bIn * 810) + (cIn * 5) + aIn + 382;
        uint256 z = (cIn * 1094) + (aIn * 7) + bIn + 390;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_372(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 185) + (bIn * 3) + cIn + 372;
        uint256 y = (bIn * 833) + (cIn * 5) + aIn + 383;
        uint256 z = (cIn * 1125) + (aIn * 7) + bIn + 391;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_373(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 202) + (bIn * 3) + cIn + 373;
        uint256 y = (bIn * 856) + (cIn * 5) + aIn + 384;
        uint256 z = (cIn * 1156) + (aIn * 7) + bIn + 392;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_374(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 219) + (bIn * 3) + cIn + 374;
        uint256 y = (bIn * 879) + (cIn * 5) + aIn + 385;
        uint256 z = (cIn * 1187) + (aIn * 7) + bIn + 393;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_375(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 236) + (bIn * 3) + cIn + 375;
        uint256 y = (bIn * 902) + (cIn * 5) + aIn + 386;
        uint256 z = (cIn * 1218) + (aIn * 7) + bIn + 394;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_376(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 253) + (bIn * 3) + cIn + 376;
        uint256 y = (bIn * 925) + (cIn * 5) + aIn + 387;
        uint256 z = (cIn * 1249) + (aIn * 7) + bIn + 395;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_377(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 270) + (bIn * 3) + cIn + 377;
        uint256 y = (bIn * 948) + (cIn * 5) + aIn + 388;
        uint256 z = (cIn * 1280) + (aIn * 7) + bIn + 396;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_378(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 287) + (bIn * 3) + cIn + 378;
        uint256 y = (bIn * 971) + (cIn * 5) + aIn + 389;
        uint256 z = (cIn * 1311) + (aIn * 7) + bIn + 397;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_379(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 304) + (bIn * 3) + cIn + 379;
        uint256 y = (bIn * 994) + (cIn * 5) + aIn + 390;
        uint256 z = (cIn * 365) + (aIn * 7) + bIn + 398;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_380(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 321) + (bIn * 3) + cIn + 380;
        uint256 y = (bIn * 1017) + (cIn * 5) + aIn + 391;
        uint256 z = (cIn * 396) + (aIn * 7) + bIn + 399;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_381(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 338) + (bIn * 3) + cIn + 381;
        uint256 y = (bIn * 1040) + (cIn * 5) + aIn + 392;
        uint256 z = (cIn * 427) + (aIn * 7) + bIn + 400;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_382(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 355) + (bIn * 3) + cIn + 382;
        uint256 y = (bIn * 1063) + (cIn * 5) + aIn + 393;
        uint256 z = (cIn * 458) + (aIn * 7) + bIn + 401;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_383(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 372) + (bIn * 3) + cIn + 383;
        uint256 y = (bIn * 1086) + (cIn * 5) + aIn + 394;
        uint256 z = (cIn * 489) + (aIn * 7) + bIn + 402;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_384(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 389) + (bIn * 3) + cIn + 384;
        uint256 y = (bIn * 1109) + (cIn * 5) + aIn + 395;
        uint256 z = (cIn * 520) + (aIn * 7) + bIn + 403;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_385(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 406) + (bIn * 3) + cIn + 385;
        uint256 y = (bIn * 1132) + (cIn * 5) + aIn + 396;
        uint256 z = (cIn * 551) + (aIn * 7) + bIn + 404;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_386(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 423) + (bIn * 3) + cIn + 386;
        uint256 y = (bIn * 268) + (cIn * 5) + aIn + 397;
        uint256 z = (cIn * 582) + (aIn * 7) + bIn + 405;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_387(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 440) + (bIn * 3) + cIn + 387;
        uint256 y = (bIn * 291) + (cIn * 5) + aIn + 398;
        uint256 z = (cIn * 613) + (aIn * 7) + bIn + 406;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_388(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 457) + (bIn * 3) + cIn + 388;
        uint256 y = (bIn * 314) + (cIn * 5) + aIn + 399;
        uint256 z = (cIn * 644) + (aIn * 7) + bIn + 407;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_389(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 474) + (bIn * 3) + cIn + 389;
        uint256 y = (bIn * 337) + (cIn * 5) + aIn + 400;
        uint256 z = (cIn * 675) + (aIn * 7) + bIn + 408;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_390(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 491) + (bIn * 3) + cIn + 390;
        uint256 y = (bIn * 360) + (cIn * 5) + aIn + 401;
        uint256 z = (cIn * 706) + (aIn * 7) + bIn + 409;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_391(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 508) + (bIn * 3) + cIn + 391;
        uint256 y = (bIn * 383) + (cIn * 5) + aIn + 402;
        uint256 z = (cIn * 737) + (aIn * 7) + bIn + 410;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_392(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 525) + (bIn * 3) + cIn + 392;
        uint256 y = (bIn * 406) + (cIn * 5) + aIn + 403;
        uint256 z = (cIn * 768) + (aIn * 7) + bIn + 411;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_393(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 542) + (bIn * 3) + cIn + 393;
        uint256 y = (bIn * 429) + (cIn * 5) + aIn + 404;
        uint256 z = (cIn * 799) + (aIn * 7) + bIn + 412;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_394(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 559) + (bIn * 3) + cIn + 394;
        uint256 y = (bIn * 452) + (cIn * 5) + aIn + 405;
        uint256 z = (cIn * 830) + (aIn * 7) + bIn + 413;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_395(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 576) + (bIn * 3) + cIn + 395;
        uint256 y = (bIn * 475) + (cIn * 5) + aIn + 406;
        uint256 z = (cIn * 861) + (aIn * 7) + bIn + 414;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_396(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 593) + (bIn * 3) + cIn + 396;
        uint256 y = (bIn * 498) + (cIn * 5) + aIn + 407;
        uint256 z = (cIn * 892) + (aIn * 7) + bIn + 415;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_397(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 610) + (bIn * 3) + cIn + 397;
        uint256 y = (bIn * 521) + (cIn * 5) + aIn + 408;
        uint256 z = (cIn * 923) + (aIn * 7) + bIn + 416;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_398(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 627) + (bIn * 3) + cIn + 398;
        uint256 y = (bIn * 544) + (cIn * 5) + aIn + 409;
        uint256 z = (cIn * 954) + (aIn * 7) + bIn + 417;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_399(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 644) + (bIn * 3) + cIn + 399;
        uint256 y = (bIn * 567) + (cIn * 5) + aIn + 410;
        uint256 z = (cIn * 985) + (aIn * 7) + bIn + 418;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_400(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 661) + (bIn * 3) + cIn + 400;
        uint256 y = (bIn * 590) + (cIn * 5) + aIn + 411;
        uint256 z = (cIn * 1016) + (aIn * 7) + bIn + 419;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_401(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 678) + (bIn * 3) + cIn + 401;
        uint256 y = (bIn * 613) + (cIn * 5) + aIn + 412;
        uint256 z = (cIn * 1047) + (aIn * 7) + bIn + 420;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_402(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 695) + (bIn * 3) + cIn + 402;
        uint256 y = (bIn * 636) + (cIn * 5) + aIn + 413;
        uint256 z = (cIn * 1078) + (aIn * 7) + bIn + 421;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_403(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 712) + (bIn * 3) + cIn + 403;
        uint256 y = (bIn * 659) + (cIn * 5) + aIn + 414;
        uint256 z = (cIn * 1109) + (aIn * 7) + bIn + 422;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_404(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 729) + (bIn * 3) + cIn + 404;
        uint256 y = (bIn * 682) + (cIn * 5) + aIn + 415;
        uint256 z = (cIn * 1140) + (aIn * 7) + bIn + 423;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_405(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 746) + (bIn * 3) + cIn + 405;
        uint256 y = (bIn * 705) + (cIn * 5) + aIn + 416;
        uint256 z = (cIn * 1171) + (aIn * 7) + bIn + 424;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_406(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 763) + (bIn * 3) + cIn + 406;
        uint256 y = (bIn * 728) + (cIn * 5) + aIn + 417;
        uint256 z = (cIn * 1202) + (aIn * 7) + bIn + 425;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_407(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 780) + (bIn * 3) + cIn + 407;
        uint256 y = (bIn * 751) + (cIn * 5) + aIn + 418;
        uint256 z = (cIn * 1233) + (aIn * 7) + bIn + 426;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_408(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 797) + (bIn * 3) + cIn + 408;
        uint256 y = (bIn * 774) + (cIn * 5) + aIn + 419;
        uint256 z = (cIn * 1264) + (aIn * 7) + bIn + 427;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_409(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 814) + (bIn * 3) + cIn + 409;
        uint256 y = (bIn * 797) + (cIn * 5) + aIn + 420;
        uint256 z = (cIn * 1295) + (aIn * 7) + bIn + 428;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_410(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 831) + (bIn * 3) + cIn + 410;
        uint256 y = (bIn * 820) + (cIn * 5) + aIn + 421;
        uint256 z = (cIn * 349) + (aIn * 7) + bIn + 429;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_411(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 848) + (bIn * 3) + cIn + 411;
        uint256 y = (bIn * 843) + (cIn * 5) + aIn + 422;
        uint256 z = (cIn * 380) + (aIn * 7) + bIn + 430;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_412(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 865) + (bIn * 3) + cIn + 412;
        uint256 y = (bIn * 866) + (cIn * 5) + aIn + 423;
        uint256 z = (cIn * 411) + (aIn * 7) + bIn + 431;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_413(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 181) + (bIn * 3) + cIn + 413;
        uint256 y = (bIn * 889) + (cIn * 5) + aIn + 424;
        uint256 z = (cIn * 442) + (aIn * 7) + bIn + 432;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_414(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 198) + (bIn * 3) + cIn + 414;
        uint256 y = (bIn * 912) + (cIn * 5) + aIn + 425;
        uint256 z = (cIn * 473) + (aIn * 7) + bIn + 433;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_415(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 215) + (bIn * 3) + cIn + 415;
        uint256 y = (bIn * 935) + (cIn * 5) + aIn + 426;
        uint256 z = (cIn * 504) + (aIn * 7) + bIn + 434;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_416(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 232) + (bIn * 3) + cIn + 416;
        uint256 y = (bIn * 958) + (cIn * 5) + aIn + 427;
        uint256 z = (cIn * 535) + (aIn * 7) + bIn + 435;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_417(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 249) + (bIn * 3) + cIn + 417;
        uint256 y = (bIn * 981) + (cIn * 5) + aIn + 428;
        uint256 z = (cIn * 566) + (aIn * 7) + bIn + 436;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_418(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 266) + (bIn * 3) + cIn + 418;
        uint256 y = (bIn * 1004) + (cIn * 5) + aIn + 429;
        uint256 z = (cIn * 597) + (aIn * 7) + bIn + 437;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_419(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 283) + (bIn * 3) + cIn + 419;
        uint256 y = (bIn * 1027) + (cIn * 5) + aIn + 430;
        uint256 z = (cIn * 628) + (aIn * 7) + bIn + 438;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_420(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 300) + (bIn * 3) + cIn + 420;
        uint256 y = (bIn * 1050) + (cIn * 5) + aIn + 431;
        uint256 z = (cIn * 659) + (aIn * 7) + bIn + 439;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_421(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 317) + (bIn * 3) + cIn + 421;
        uint256 y = (bIn * 1073) + (cIn * 5) + aIn + 432;
        uint256 z = (cIn * 690) + (aIn * 7) + bIn + 440;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_422(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 334) + (bIn * 3) + cIn + 422;
        uint256 y = (bIn * 1096) + (cIn * 5) + aIn + 433;
        uint256 z = (cIn * 721) + (aIn * 7) + bIn + 441;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_423(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 351) + (bIn * 3) + cIn + 423;
        uint256 y = (bIn * 1119) + (cIn * 5) + aIn + 434;
        uint256 z = (cIn * 752) + (aIn * 7) + bIn + 442;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_424(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 368) + (bIn * 3) + cIn + 424;
        uint256 y = (bIn * 1142) + (cIn * 5) + aIn + 435;
        uint256 z = (cIn * 783) + (aIn * 7) + bIn + 443;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_425(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 385) + (bIn * 3) + cIn + 425;
        uint256 y = (bIn * 278) + (cIn * 5) + aIn + 436;
        uint256 z = (cIn * 814) + (aIn * 7) + bIn + 444;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_426(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 402) + (bIn * 3) + cIn + 426;
        uint256 y = (bIn * 301) + (cIn * 5) + aIn + 437;
        uint256 z = (cIn * 845) + (aIn * 7) + bIn + 445;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_427(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 419) + (bIn * 3) + cIn + 427;
        uint256 y = (bIn * 324) + (cIn * 5) + aIn + 438;
        uint256 z = (cIn * 876) + (aIn * 7) + bIn + 446;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_428(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 436) + (bIn * 3) + cIn + 428;
        uint256 y = (bIn * 347) + (cIn * 5) + aIn + 439;
        uint256 z = (cIn * 907) + (aIn * 7) + bIn + 447;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_429(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 453) + (bIn * 3) + cIn + 429;
        uint256 y = (bIn * 370) + (cIn * 5) + aIn + 440;
        uint256 z = (cIn * 938) + (aIn * 7) + bIn + 448;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_430(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 470) + (bIn * 3) + cIn + 430;
        uint256 y = (bIn * 393) + (cIn * 5) + aIn + 441;
        uint256 z = (cIn * 969) + (aIn * 7) + bIn + 449;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_431(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 487) + (bIn * 3) + cIn + 431;
        uint256 y = (bIn * 416) + (cIn * 5) + aIn + 442;
        uint256 z = (cIn * 1000) + (aIn * 7) + bIn + 450;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_432(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 504) + (bIn * 3) + cIn + 432;
        uint256 y = (bIn * 439) + (cIn * 5) + aIn + 443;
        uint256 z = (cIn * 1031) + (aIn * 7) + bIn + 451;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_433(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 521) + (bIn * 3) + cIn + 433;
        uint256 y = (bIn * 462) + (cIn * 5) + aIn + 444;
        uint256 z = (cIn * 1062) + (aIn * 7) + bIn + 452;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_434(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 538) + (bIn * 3) + cIn + 434;
        uint256 y = (bIn * 485) + (cIn * 5) + aIn + 445;
        uint256 z = (cIn * 1093) + (aIn * 7) + bIn + 453;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_435(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 555) + (bIn * 3) + cIn + 435;
        uint256 y = (bIn * 508) + (cIn * 5) + aIn + 446;
        uint256 z = (cIn * 1124) + (aIn * 7) + bIn + 454;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_436(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 572) + (bIn * 3) + cIn + 436;
        uint256 y = (bIn * 531) + (cIn * 5) + aIn + 447;
        uint256 z = (cIn * 1155) + (aIn * 7) + bIn + 455;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_437(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 589) + (bIn * 3) + cIn + 437;
        uint256 y = (bIn * 554) + (cIn * 5) + aIn + 448;
        uint256 z = (cIn * 1186) + (aIn * 7) + bIn + 456;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_438(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 606) + (bIn * 3) + cIn + 438;
        uint256 y = (bIn * 577) + (cIn * 5) + aIn + 449;
        uint256 z = (cIn * 1217) + (aIn * 7) + bIn + 457;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_439(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 623) + (bIn * 3) + cIn + 439;
        uint256 y = (bIn * 600) + (cIn * 5) + aIn + 450;
        uint256 z = (cIn * 1248) + (aIn * 7) + bIn + 458;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_440(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 640) + (bIn * 3) + cIn + 440;
        uint256 y = (bIn * 623) + (cIn * 5) + aIn + 451;
        uint256 z = (cIn * 1279) + (aIn * 7) + bIn + 459;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_441(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 657) + (bIn * 3) + cIn + 441;
        uint256 y = (bIn * 646) + (cIn * 5) + aIn + 452;
        uint256 z = (cIn * 1310) + (aIn * 7) + bIn + 460;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_442(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 674) + (bIn * 3) + cIn + 442;
        uint256 y = (bIn * 669) + (cIn * 5) + aIn + 453;
        uint256 z = (cIn * 364) + (aIn * 7) + bIn + 461;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_443(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 691) + (bIn * 3) + cIn + 443;
        uint256 y = (bIn * 692) + (cIn * 5) + aIn + 454;
        uint256 z = (cIn * 395) + (aIn * 7) + bIn + 462;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_444(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 708) + (bIn * 3) + cIn + 444;
        uint256 y = (bIn * 715) + (cIn * 5) + aIn + 455;
        uint256 z = (cIn * 426) + (aIn * 7) + bIn + 463;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_445(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 725) + (bIn * 3) + cIn + 445;
        uint256 y = (bIn * 738) + (cIn * 5) + aIn + 456;
        uint256 z = (cIn * 457) + (aIn * 7) + bIn + 464;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_446(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 742) + (bIn * 3) + cIn + 446;
        uint256 y = (bIn * 761) + (cIn * 5) + aIn + 457;
        uint256 z = (cIn * 488) + (aIn * 7) + bIn + 465;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_447(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 759) + (bIn * 3) + cIn + 447;
        uint256 y = (bIn * 784) + (cIn * 5) + aIn + 458;
        uint256 z = (cIn * 519) + (aIn * 7) + bIn + 466;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_448(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 776) + (bIn * 3) + cIn + 448;
        uint256 y = (bIn * 807) + (cIn * 5) + aIn + 459;
        uint256 z = (cIn * 550) + (aIn * 7) + bIn + 467;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_449(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 793) + (bIn * 3) + cIn + 449;
        uint256 y = (bIn * 830) + (cIn * 5) + aIn + 460;
        uint256 z = (cIn * 581) + (aIn * 7) + bIn + 468;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_450(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 810) + (bIn * 3) + cIn + 450;
        uint256 y = (bIn * 853) + (cIn * 5) + aIn + 461;
        uint256 z = (cIn * 612) + (aIn * 7) + bIn + 469;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_451(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 827) + (bIn * 3) + cIn + 451;
        uint256 y = (bIn * 876) + (cIn * 5) + aIn + 462;
        uint256 z = (cIn * 643) + (aIn * 7) + bIn + 470;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_452(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 844) + (bIn * 3) + cIn + 452;
        uint256 y = (bIn * 899) + (cIn * 5) + aIn + 463;
        uint256 z = (cIn * 674) + (aIn * 7) + bIn + 471;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_453(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 861) + (bIn * 3) + cIn + 453;
        uint256 y = (bIn * 922) + (cIn * 5) + aIn + 464;
        uint256 z = (cIn * 705) + (aIn * 7) + bIn + 472;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_454(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 177) + (bIn * 3) + cIn + 454;
        uint256 y = (bIn * 945) + (cIn * 5) + aIn + 465;
        uint256 z = (cIn * 736) + (aIn * 7) + bIn + 473;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_455(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 194) + (bIn * 3) + cIn + 455;
        uint256 y = (bIn * 968) + (cIn * 5) + aIn + 466;
        uint256 z = (cIn * 767) + (aIn * 7) + bIn + 474;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_456(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 211) + (bIn * 3) + cIn + 456;
        uint256 y = (bIn * 991) + (cIn * 5) + aIn + 467;
        uint256 z = (cIn * 798) + (aIn * 7) + bIn + 475;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_457(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 228) + (bIn * 3) + cIn + 457;
        uint256 y = (bIn * 1014) + (cIn * 5) + aIn + 468;
        uint256 z = (cIn * 829) + (aIn * 7) + bIn + 476;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_458(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 245) + (bIn * 3) + cIn + 458;
        uint256 y = (bIn * 1037) + (cIn * 5) + aIn + 469;
        uint256 z = (cIn * 860) + (aIn * 7) + bIn + 477;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_459(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 262) + (bIn * 3) + cIn + 459;
        uint256 y = (bIn * 1060) + (cIn * 5) + aIn + 470;
        uint256 z = (cIn * 891) + (aIn * 7) + bIn + 478;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_460(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 279) + (bIn * 3) + cIn + 460;
        uint256 y = (bIn * 1083) + (cIn * 5) + aIn + 471;
        uint256 z = (cIn * 922) + (aIn * 7) + bIn + 479;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_461(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 296) + (bIn * 3) + cIn + 461;
        uint256 y = (bIn * 1106) + (cIn * 5) + aIn + 472;
        uint256 z = (cIn * 953) + (aIn * 7) + bIn + 480;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_462(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 313) + (bIn * 3) + cIn + 462;
        uint256 y = (bIn * 1129) + (cIn * 5) + aIn + 473;
        uint256 z = (cIn * 984) + (aIn * 7) + bIn + 481;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_463(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 330) + (bIn * 3) + cIn + 463;
        uint256 y = (bIn * 265) + (cIn * 5) + aIn + 474;
        uint256 z = (cIn * 1015) + (aIn * 7) + bIn + 482;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_464(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 347) + (bIn * 3) + cIn + 464;
        uint256 y = (bIn * 288) + (cIn * 5) + aIn + 475;
        uint256 z = (cIn * 1046) + (aIn * 7) + bIn + 483;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_465(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 364) + (bIn * 3) + cIn + 465;
        uint256 y = (bIn * 311) + (cIn * 5) + aIn + 476;
        uint256 z = (cIn * 1077) + (aIn * 7) + bIn + 484;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_466(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 381) + (bIn * 3) + cIn + 466;
        uint256 y = (bIn * 334) + (cIn * 5) + aIn + 477;
        uint256 z = (cIn * 1108) + (aIn * 7) + bIn + 485;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_467(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 398) + (bIn * 3) + cIn + 467;
        uint256 y = (bIn * 357) + (cIn * 5) + aIn + 478;
        uint256 z = (cIn * 1139) + (aIn * 7) + bIn + 486;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_468(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 415) + (bIn * 3) + cIn + 468;
        uint256 y = (bIn * 380) + (cIn * 5) + aIn + 479;
        uint256 z = (cIn * 1170) + (aIn * 7) + bIn + 487;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_469(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 432) + (bIn * 3) + cIn + 469;
        uint256 y = (bIn * 403) + (cIn * 5) + aIn + 480;
        uint256 z = (cIn * 1201) + (aIn * 7) + bIn + 488;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_470(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 449) + (bIn * 3) + cIn + 470;
        uint256 y = (bIn * 426) + (cIn * 5) + aIn + 481;
        uint256 z = (cIn * 1232) + (aIn * 7) + bIn + 489;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_471(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 466) + (bIn * 3) + cIn + 471;
        uint256 y = (bIn * 449) + (cIn * 5) + aIn + 482;
        uint256 z = (cIn * 1263) + (aIn * 7) + bIn + 490;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_472(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 483) + (bIn * 3) + cIn + 472;
        uint256 y = (bIn * 472) + (cIn * 5) + aIn + 483;
        uint256 z = (cIn * 1294) + (aIn * 7) + bIn + 491;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_473(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 500) + (bIn * 3) + cIn + 473;
        uint256 y = (bIn * 495) + (cIn * 5) + aIn + 484;
        uint256 z = (cIn * 348) + (aIn * 7) + bIn + 492;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_474(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 517) + (bIn * 3) + cIn + 474;
        uint256 y = (bIn * 518) + (cIn * 5) + aIn + 485;
        uint256 z = (cIn * 379) + (aIn * 7) + bIn + 493;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_475(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 534) + (bIn * 3) + cIn + 475;
        uint256 y = (bIn * 541) + (cIn * 5) + aIn + 486;
        uint256 z = (cIn * 410) + (aIn * 7) + bIn + 494;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_476(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 551) + (bIn * 3) + cIn + 476;
        uint256 y = (bIn * 564) + (cIn * 5) + aIn + 487;
        uint256 z = (cIn * 441) + (aIn * 7) + bIn + 495;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_477(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 568) + (bIn * 3) + cIn + 477;
        uint256 y = (bIn * 587) + (cIn * 5) + aIn + 488;
        uint256 z = (cIn * 472) + (aIn * 7) + bIn + 496;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_478(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 585) + (bIn * 3) + cIn + 478;
        uint256 y = (bIn * 610) + (cIn * 5) + aIn + 489;
        uint256 z = (cIn * 503) + (aIn * 7) + bIn + 497;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_479(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 602) + (bIn * 3) + cIn + 479;
        uint256 y = (bIn * 633) + (cIn * 5) + aIn + 490;
        uint256 z = (cIn * 534) + (aIn * 7) + bIn + 498;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_480(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 619) + (bIn * 3) + cIn + 480;
        uint256 y = (bIn * 656) + (cIn * 5) + aIn + 491;
        uint256 z = (cIn * 565) + (aIn * 7) + bIn + 499;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_481(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 636) + (bIn * 3) + cIn + 481;
        uint256 y = (bIn * 679) + (cIn * 5) + aIn + 492;
        uint256 z = (cIn * 596) + (aIn * 7) + bIn + 500;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_482(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 653) + (bIn * 3) + cIn + 482;
        uint256 y = (bIn * 702) + (cIn * 5) + aIn + 493;
        uint256 z = (cIn * 627) + (aIn * 7) + bIn + 501;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_483(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 670) + (bIn * 3) + cIn + 483;
        uint256 y = (bIn * 725) + (cIn * 5) + aIn + 494;
        uint256 z = (cIn * 658) + (aIn * 7) + bIn + 502;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_484(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 687) + (bIn * 3) + cIn + 484;
        uint256 y = (bIn * 748) + (cIn * 5) + aIn + 495;
        uint256 z = (cIn * 689) + (aIn * 7) + bIn + 503;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_485(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 704) + (bIn * 3) + cIn + 485;
        uint256 y = (bIn * 771) + (cIn * 5) + aIn + 496;
        uint256 z = (cIn * 720) + (aIn * 7) + bIn + 504;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_486(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 721) + (bIn * 3) + cIn + 486;
        uint256 y = (bIn * 794) + (cIn * 5) + aIn + 497;
        uint256 z = (cIn * 751) + (aIn * 7) + bIn + 505;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_487(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 738) + (bIn * 3) + cIn + 487;
        uint256 y = (bIn * 817) + (cIn * 5) + aIn + 498;
        uint256 z = (cIn * 782) + (aIn * 7) + bIn + 506;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_488(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 755) + (bIn * 3) + cIn + 488;
        uint256 y = (bIn * 840) + (cIn * 5) + aIn + 499;
        uint256 z = (cIn * 813) + (aIn * 7) + bIn + 507;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_489(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 772) + (bIn * 3) + cIn + 489;
        uint256 y = (bIn * 863) + (cIn * 5) + aIn + 500;
        uint256 z = (cIn * 844) + (aIn * 7) + bIn + 508;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_490(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 789) + (bIn * 3) + cIn + 490;
        uint256 y = (bIn * 886) + (cIn * 5) + aIn + 501;
        uint256 z = (cIn * 875) + (aIn * 7) + bIn + 509;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_491(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 806) + (bIn * 3) + cIn + 491;
        uint256 y = (bIn * 909) + (cIn * 5) + aIn + 502;
        uint256 z = (cIn * 906) + (aIn * 7) + bIn + 510;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_492(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 823) + (bIn * 3) + cIn + 492;
        uint256 y = (bIn * 932) + (cIn * 5) + aIn + 503;
        uint256 z = (cIn * 937) + (aIn * 7) + bIn + 511;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_493(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 840) + (bIn * 3) + cIn + 493;
        uint256 y = (bIn * 955) + (cIn * 5) + aIn + 504;
        uint256 z = (cIn * 968) + (aIn * 7) + bIn + 512;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_494(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 857) + (bIn * 3) + cIn + 494;
        uint256 y = (bIn * 978) + (cIn * 5) + aIn + 505;
        uint256 z = (cIn * 999) + (aIn * 7) + bIn + 513;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_495(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 173) + (bIn * 3) + cIn + 495;
        uint256 y = (bIn * 1001) + (cIn * 5) + aIn + 506;
        uint256 z = (cIn * 1030) + (aIn * 7) + bIn + 514;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_496(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 190) + (bIn * 3) + cIn + 496;
        uint256 y = (bIn * 1024) + (cIn * 5) + aIn + 507;
        uint256 z = (cIn * 1061) + (aIn * 7) + bIn + 515;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_497(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 207) + (bIn * 3) + cIn + 497;
        uint256 y = (bIn * 1047) + (cIn * 5) + aIn + 508;
        uint256 z = (cIn * 1092) + (aIn * 7) + bIn + 516;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_498(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 224) + (bIn * 3) + cIn + 498;
        uint256 y = (bIn * 1070) + (cIn * 5) + aIn + 509;
        uint256 z = (cIn * 1123) + (aIn * 7) + bIn + 517;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_499(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 241) + (bIn * 3) + cIn + 499;
        uint256 y = (bIn * 1093) + (cIn * 5) + aIn + 510;
        uint256 z = (cIn * 1154) + (aIn * 7) + bIn + 518;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_500(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 258) + (bIn * 3) + cIn + 500;
        uint256 y = (bIn * 1116) + (cIn * 5) + aIn + 511;
        uint256 z = (cIn * 1185) + (aIn * 7) + bIn + 519;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_501(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 275) + (bIn * 3) + cIn + 501;
        uint256 y = (bIn * 1139) + (cIn * 5) + aIn + 512;
        uint256 z = (cIn * 1216) + (aIn * 7) + bIn + 520;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_502(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 292) + (bIn * 3) + cIn + 502;
        uint256 y = (bIn * 275) + (cIn * 5) + aIn + 513;
        uint256 z = (cIn * 1247) + (aIn * 7) + bIn + 521;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_503(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 309) + (bIn * 3) + cIn + 503;
        uint256 y = (bIn * 298) + (cIn * 5) + aIn + 514;
        uint256 z = (cIn * 1278) + (aIn * 7) + bIn + 522;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_504(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 326) + (bIn * 3) + cIn + 504;
        uint256 y = (bIn * 321) + (cIn * 5) + aIn + 515;
        uint256 z = (cIn * 1309) + (aIn * 7) + bIn + 523;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_505(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 343) + (bIn * 3) + cIn + 505;
        uint256 y = (bIn * 344) + (cIn * 5) + aIn + 516;
        uint256 z = (cIn * 363) + (aIn * 7) + bIn + 524;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_506(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 360) + (bIn * 3) + cIn + 506;
        uint256 y = (bIn * 367) + (cIn * 5) + aIn + 517;
        uint256 z = (cIn * 394) + (aIn * 7) + bIn + 525;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_507(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 377) + (bIn * 3) + cIn + 507;
        uint256 y = (bIn * 390) + (cIn * 5) + aIn + 518;
        uint256 z = (cIn * 425) + (aIn * 7) + bIn + 526;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_508(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 394) + (bIn * 3) + cIn + 508;
        uint256 y = (bIn * 413) + (cIn * 5) + aIn + 519;
        uint256 z = (cIn * 456) + (aIn * 7) + bIn + 527;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_509(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 411) + (bIn * 3) + cIn + 509;
        uint256 y = (bIn * 436) + (cIn * 5) + aIn + 520;
        uint256 z = (cIn * 487) + (aIn * 7) + bIn + 528;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_510(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 428) + (bIn * 3) + cIn + 510;
        uint256 y = (bIn * 459) + (cIn * 5) + aIn + 521;
        uint256 z = (cIn * 518) + (aIn * 7) + bIn + 529;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_511(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 445) + (bIn * 3) + cIn + 511;
        uint256 y = (bIn * 482) + (cIn * 5) + aIn + 522;
        uint256 z = (cIn * 549) + (aIn * 7) + bIn + 530;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_512(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 462) + (bIn * 3) + cIn + 512;
        uint256 y = (bIn * 505) + (cIn * 5) + aIn + 523;
        uint256 z = (cIn * 580) + (aIn * 7) + bIn + 531;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_513(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 479) + (bIn * 3) + cIn + 513;
        uint256 y = (bIn * 528) + (cIn * 5) + aIn + 524;
        uint256 z = (cIn * 611) + (aIn * 7) + bIn + 532;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_514(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 496) + (bIn * 3) + cIn + 514;
        uint256 y = (bIn * 551) + (cIn * 5) + aIn + 525;
        uint256 z = (cIn * 642) + (aIn * 7) + bIn + 533;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_515(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 513) + (bIn * 3) + cIn + 515;
        uint256 y = (bIn * 574) + (cIn * 5) + aIn + 526;
        uint256 z = (cIn * 673) + (aIn * 7) + bIn + 534;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_516(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 530) + (bIn * 3) + cIn + 516;
        uint256 y = (bIn * 597) + (cIn * 5) + aIn + 527;
        uint256 z = (cIn * 704) + (aIn * 7) + bIn + 535;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_517(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 547) + (bIn * 3) + cIn + 517;
        uint256 y = (bIn * 620) + (cIn * 5) + aIn + 528;
        uint256 z = (cIn * 735) + (aIn * 7) + bIn + 536;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_518(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 564) + (bIn * 3) + cIn + 518;
        uint256 y = (bIn * 643) + (cIn * 5) + aIn + 529;
        uint256 z = (cIn * 766) + (aIn * 7) + bIn + 537;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_519(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 581) + (bIn * 3) + cIn + 519;
        uint256 y = (bIn * 666) + (cIn * 5) + aIn + 530;
        uint256 z = (cIn * 797) + (aIn * 7) + bIn + 538;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }

    function refineryEnvelope_520(uint256 aIn, uint256 bIn, uint256 cIn) external pure returns (uint256 m1, uint256 m2, uint256 m3) {
        uint256 x = (aIn * 598) + (bIn * 3) + cIn + 520;
        uint256 y = (bIn * 689) + (cIn * 5) + aIn + 531;
        uint256 z = (cIn * 828) + (aIn * 7) + bIn + 539;
        m1 = (x ^ y) + (z / 2);
        m2 = (y ^ z) + (x / 3);
        m3 = uint256(keccak256(abi.encodePacked(m1, m2, x, y, z)));
    }
